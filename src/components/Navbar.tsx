...
//         <button className="flex items-center gap-1 px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
...
//       case 'admin':
//         links.push(
//           <Link key="map" href="/map" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             <span className="flex items-center gap-2"><MapIcon className='size-4'/> Carte</span>
//           </Link>,
//           <Link key="transferts" href="/admin/transferts" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             <span className="flex items-center gap-2"><RefreshCcw className='size-4'/> Transferts</span>
//           </Link>,
//           <Link key="conference" href="/admin/conference" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Conference
//           </Link>,
//           <Link key="chefDepartements" href="/admin/chefs" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Chef departements
//           </Link>,
 
//           <Link key="management" href="/admin/management" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             <span className="flex items-center gap-2"><Shield className='size-4'/> Gestion</span>
//           </Link>,
//           <Link key="users" href="/admin/users" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             <span className="flex items-center gap-2"><Users2 className='size-4'/> Utilisateurs</span>
//           </Link>,
//           <Link key="fideles" href="/admin/fideles" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             <span className="flex items-center gap-2"><UserCog2 className='size-4'/> Fidèles</span>
//           </Link>,
//           <Link key="admin-dep" href="/admin/departements" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Départements
//           </Link>,
//           <Link key="managemwent" href="/admin/management" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Management 
//           </Link>,
//           <Link key="pasteurs" href="/admin/pasteurs" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             <span className="flex items-center gap-2"><Church className='size-4'/> Pasteurs</span>
//           </Link>,
//           <Link key="roles" href="/admin/role" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             <span className="flex items-center gap-2"><CogIcon className='size-4'/> Rôles</span>
//           </Link>,
          
//           <Link key="annee" href="/admin/annees" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             <span className="flex items-center gap-2"><CalendarClock className='size-4'/> Année</span>
//           </Link>,
//           <Link key="chef" href="/admin/chef" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             <span className="flex items-center gap-2"><BadgeCheck className='size-4'/>Chefs</span>
//           </Link>,
//           <Link key="cabinet" href="/admin/cabinet" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
...
//         links.push(
//           <Link key="paroisse-fideles" href="/paroisse/fideles" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Fideles
//           </Link>,
//           <Link key="cabinet" href="/cabinet" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Gestion Cabinet
//           </Link>,
//           <Link key="paroisse-activites" href="/paroisse/activites" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Activités
//           </Link>,
//           <Link key="paroisse-transferts" href="/paroisse/transferts" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             <span className="flex items-center gap-2"><RefreshCcwDot className='size-4'/> Transferts</span>
//           </Link>,
//           <Link key="paroisse-departements" href="/paroisse/admin/departements" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Admin Departements
//           </Link>,
//           <Link key="admin-cabinet" href="/cabinet/admin" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Admin Cabinet
//           </Link>,
//           <Link key="hebdo" href="/hebdo" className="px-2 flex items-center gap-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap  w-full">
...
//           <Link key="paroisse-departements" href="/paroisse/departements" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Departements
//           </Link>,
//           <Link key="paroisse-activites" href="/paroisse/activites" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Activités
...
//             <span className="flex items-center gap-2"><RefreshCcwDot className='size-4'/> Transferts</span>
//           </Link>,
//           <Link key="paroisse-dep" href="/departement" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Gestion
//           </Link>
//         )
//         break
...
//         links.push(
//           <Link key="district-departements" href="/chef/departement/district" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Departements district
//           </Link>,
//           <Link key="district-annee" href="/district/annee-departement" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Annee
//           </Link>,
//           <Link key="district-gestion" href="/district" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Gestion
//           </Link>
//         )
//         break
...
//         links.push(
//           <Link key="conference-pasteurs" href="/conference/pasteurs" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Pasteurs
//           </Link>,
//           <Link key="conference-gestion" href="/conference" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Gestion (activites-plan-budget)
//           </Link>,
//           <Link key="conference-departements" href="/chef/departement/conference" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Departements (Tous district)
//           </Link>,
//           <Link key="conference-districts" href="/chef-conference" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Gestion Districts 
//           </Link>,
          
//           <Link key="conference-annee" href="/chef-conference/annees" className="px-2 py-2 rounded-md text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors whitespace-nowrap block w-full">
//             Gestion Annee
//           </Link>
//         )
//         break
...
//       case 'admin':
//         links.push(
//           <Link key="map-mobile" href="/map" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <MapIcon className='size-5'/><span>Carte</span>
//           </Link>,
//           <Link key="transferts-mobile" href="/admin/transferts" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <RefreshCcw className='size-5'/><span>Transferts</span>
//           </Link>,
//           <Link key="conference-mobile" href="/admin/conference" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Conference</span>
//           </Link>,
//           <Link key="chef-dist-mobile" href="/admin/districts/chefs" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Chef-district</span>
//           </Link>,
//           <Link key="chef-conf-mobile" href="/admin/conferences/chefs" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Chef-conférence</span>
//           </Link>,
//           <Link key="annees-mobile" href="/admin/annees" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Années</span>
//           </Link>,
//           <Link key="management-mobile" href="/admin/management" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <Shield className='size-5'/><span>Gestion</span>
//           </Link>,
//           <Link key="users-mobile" href="/admin/users" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <Users2 className='size-5'/><span>Utilisateurs</span>
//           </Link>,
//           <Link key="fideles-mobile" href="/admin/fideles" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <UserCog2 className='size-5'/><span>Fidèles</span>
//           </Link>,
//           <Link key="admin-dep-mobile" href="/admin/departements" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Départements</span>
//           </Link>,
//           <Link key="pasteurs-mobile" href="/admin/pasteurs" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <Church className='size-5'/><span>Pasteurs</span>
//           </Link>,
//           <Link key="roles-mobile" href="/admin/role" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <CogIcon className='size-5'/><span>Rôles</span>
//           </Link>,
//           <Link key="stats-mobile" href="/admin/stats" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
...
//         links.push(
//           <Link key="paroisse-fideles-mobile" href="/paroisse/fideles" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Paroisse</span>
//           </Link>,
//           <Link key="paroisse-departements-mobile" href="/paroisse/departements" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Départements</span>
//           </Link>,
//           <Link key="paroisse-activites-mobile" href="/paroisse/activites" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Activités</span>
//           </Link>,
//           <Link key="paroisse-transferts-mobile" href="/paroisse/transferts" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <RefreshCcwDot className='size-5'/><span>Transferts</span>
//           </Link>,
//           <Link key="paroisse-dep-mobile" href="/paroisse/departements" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
...
//       case 'chef_departement_district':
//         links.push(
//           <Link key="district-departements-mobile" href="/district/departements" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Département-district</span>
//           </Link>,
//           <Link key="district-annee-mobile" href="/district/annee-departement" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Année</span>
//           </Link>,
//           <Link key="district-gestion-mobile" href="/district" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
...
//       case 'admin_conference':
//         links.push(
//           <Link key="conference-pasteurs-mobile" href="/conference/pasteurs" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <Church className='size-5'/><span>Pasteurs</span>
//           </Link>,
//           <Link key="conference-gestion-mobile" href="/conference" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Gestion</span>
//           </Link>,
//           <Link key="conference-departements-mobile" href="/conference/departements" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
//             <ChevronRight className='size-5'/><span>Départements (ok-district)</span>
//           </Link>,
//           <Link key="conference-districts-mobile" href="/conference/districts" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors w-full">
