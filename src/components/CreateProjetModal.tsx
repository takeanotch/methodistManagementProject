// components/CreateProjetModal.tsx
'use client'
...
export function CreateProjetModal({ isOpen, onClose, uniteId, uniteNom, onSuccess }: CreateProjetModalProps) {
            ...
            <div className="bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex justify-between items-center p-6 border-b">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Pour : {uniteNom}</p>
                    </div>
                    <button
                        onClick={onClose}
