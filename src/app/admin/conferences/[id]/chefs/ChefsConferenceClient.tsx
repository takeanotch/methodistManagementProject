...
//   departements: any[]
//   chefs: ChefDepartementConference[]
//   maxPostesParDepartement: number
//   user: any
// }

// export default function ChefsConferenceClient({ 
//   conferenceId, 
//   conferenceNom, 
//   departements, 
//   chefs: initialChefs, 
...
//   const [showEditRoleModal, setShowEditRoleModal] = useState<{show: boolean; chef: ChefDepartementConference | null}>({ show: false, chef: null })
...
//     const result = await ajouterChefDepartementConference(formData)
...
//     setLoading(true)
//     const result = await retirerChefDepartementConference(chefId, conferenceId)
...
//     const result = await updateChefRoleConference(chefId, nouveauRoleId, conferenceId)
...
//     return acc
//   }, {} as Record<number, ChefDepartementConference[]>)
...
//           <Link 
//             href={`/admin/conferences/${conferenceId}`}
//             className="text-gray-400 hover:text-gray-600 transition-colors text-sm"
//           >
//             ← Retour à la conférence
//           </Link>
//           <h1 className="text-2xl font-light text-gray-900">
//             Responsables de département - {conferenceNom}
//           </h1>
//         </div>
//         <p className="text-sm text-gray-500 ml-8">
//           Gérez les différents responsables des départements au niveau de la conférence
...
//       {/* Modal d'ajout de nouveau rôle pour conférence */}
//       <AjouterRoleModal
//         type="conference"
...
// // Modal d'ajout de chef pour conférence
// function AjouterChefConferenceModal({ 
//   conferenceId, 
//   departements, 
//   chefsExistants, 
...
//       setSearching(true)
//       try {
//         const results = await searchFidelesDisponiblesPourConference(conferenceId, query)
...
//           Ajouter un responsable de département (Conférence)
//         </h3>
...
// // Modal de modification du rôle pour conférence
// function ModifierRoleConferenceModal({ chef, departementId, chefsExistants, onClose, onUpdate, loading }: any) {
...
// app/admin/conferences/[id]/chefs/ChefsConferenceClient.tsx
'use client'
...
// Remplacer la fonction loadAnnees par celle-ci :
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-6 flex justify-between items-center gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={() => {
              // Si une année est sélectionnée, on l'utilise pour le nouveau chef
              setShowAddModal(true)
            }}
            className="bg-gray-900 text-white px-4 py-2 text-sm hover:bg-gray-800 flex items-center gap-2"
          >
