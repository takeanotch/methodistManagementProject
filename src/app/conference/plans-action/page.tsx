...
// app/conference/plans-action/page.tsx
'use client'
...
export default function ConferencePlansActionPage() {
  ...
  async function handleDelete(plan: PlanActionWithStats) {
    ...
    const result = await deletePlanActionNiveau(plan.id, 'conference')
    ...
    <div className=" max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-light tracking-wide">Plans d&apos;action de la Conférence</h1>
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <Link
                    href={`/conference/plans-action/${plan.id}`}
