// app/cabinet/CabinetProjetsClient.tsx
'use client'
...
interface CabinetProjetsClientProps {
    uniteId: number
    cabinetNom: string
    onRefresh?: () => void
}
...
export function CabinetProjetsClient({ uniteId, cabinetNom, onRefresh }: CabinetProjetsClientProps) {
    ...
    async function loadProjets() {
        setLoading(true)
        try {
            const data = await getProjetsByUnite(uniteId)
            setProjets(data)
        } catch (error) {
                                    ...
                                    <div className="relative">
                                        ...
                                        {menuOpen === projet.id && (
                                            <div className="absolute right-0 top-full mt-1 bg-white border border-gray-200 shadow-lg z-10 min-w-[150px]">
                                                <Link
                                                    href={`/cabinet/projets/${projet.id}`}
                    ...
                    <div className="bg-white w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
                        <div className="flex justify-between items-center p-4 border-b border-gray-200">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">{cabinetNom}</p>
                            </div>
                            <button
                    ...
                    <div className="bg-white w-full max-w-2xl max-h-[80vh] flex flex-col">
                        ...
                        <div className="p-4 border-b border-gray-200 bg-gray-50">
                            <input
                                ...
                                className="hidden"
                                id="file-upload-cabinet"
                                disabled={uploading}
                            />
                            <label
                                htmlFor="file-upload-cabinet"
                                className={`
