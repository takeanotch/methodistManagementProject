// // app/district/projets/NiveauProjetsClient.tsx
// // (À copier aussi dans app/conference/projets/NiveauProjetsClient.tsx)
// 'use client'

// import { useState, useEffect } from 'react'
// import { Plus, Search, Filter, MoreVertical, Edit, Trash2, Loader2, Target, Calendar, Clock, CheckCircle, XCircle, Eye, DollarSign, X } from 'lucide-react'
...
// interface NiveauProjetsClientProps {
//   uniteId: number
//   niveauNom: string
...
// export function NiveauProjetsClient({ uniteId, niveauNom, niveau, niveauId, onRefresh }: NiveauProjetsClientProps) {
...
//     setLoading(true)
//     try {
//       const [projetsData, statsData] = await Promise.all([
//         getProjetsByUnite(uniteId),
//         getProjetsStats(uniteId)
//       ])
...
//                       <Link
//                         href={`${basePath}/projets/${projet.id}`}
...
import { Plus, Search, Filter, MoreVertical, Edit, Trash2, Loader2, Target, Calendar, Clock, CheckCircle, XCircle, Eye, DollarSign, X, FileText, Upload, Download } from 'lucide-react'
import Link from 'next/link'
import toast from 'react-hot-toast'
import { 
  getProjetsByUnite, 
