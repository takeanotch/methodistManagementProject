...
//   // let unite = await getDepartementUnite(departementId, currentFidele.paroisse_id)
//   // ========== CRÉATION AUTOMATIQUE DE L'UNITÉ SI ELLE N'EXISTE PAS ==========
// let unite = await getDepartementUnite(departementId, currentFidele.paroisse_id)
...
//   let creationResult = await ensureDepartementUniteExists(departementId, currentFidele.paroisse_id)
...
//             Département ID: {departementId}, Paroisse ID: {currentFidele.paroisse_id}
//           </p>
//           <Link
...
//     getPlansActionByDepartement(departementId, currentFidele.paroisse_id),
...
//           </Link>
//           <Link
//             href={`/paroisse/departements/${departementId}/plan-action`}
//             className="px-1 py-3 text-sm text-gray-500 hover:text-black border-b-2 border-transparent hover:border-gray-300"
//           >
//             Plan d&apos;action
//           </Link>
...
//               <a
//                 key={annee.id}
//                 href={`/paroisse/departements/${departementId}?annee_conference=${annee.id}`}
...
//             <Link
//               href={buildUrl(`/paroisse/departements/${departementId}/budget`)}
...
//             <Link
//               href={buildUrl(`/paroisse/departements/${departementId}/projets`)}
...
//               <Link
//                 href={buildUrl(`/paroisse/departements/${departementId}/activites`)}
//                 className="text-xs text-gray-400 hover:text-black"
//               >
//                 Voir tout →
//               </Link>
...
//                   <Link
//                     key={activite.id}
//                     href={buildUrl(`/paroisse/departements/${departementId}/activites/${activite.id}`)}
...
//             <Link
//               href={buildUrl(`/paroisse/departements/${departementId}/plans-action`)}
//               className="text-xs text-gray-400 hover:text-black"
//             >
//               Voir tout →
//             </Link>
...
//                 <Link
//                   key={plan.id}
//                   href={buildUrl(`/paroisse/departements/${departementId}/plans-action/${plan.id}`)}
//                   className="block p-4 border-b border-gray-100 last:border-b-0 hover:bg-gray-50 transition-colors"
//                 >
