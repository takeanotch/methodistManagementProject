...
// app/paroisse/fideles/[id]/AdminFideleDetailClient.tsx
'use client'
...
import { deleteFidele, updateFidele, uploadFideleImage } from '@/actions/fidele'
import { createPasteur } from '@/actions/pasteurs'
import CreerCompteModal from '@/app/admin/fideles/CreerCompteModal'
import ExportCarteFideleButton from './ExportCarteFideleButton'
...
useEffect(() => {
  async function loadStructureInfo() {
    if (!fidele.paroisse_id) return
    
    const info = await getFullHierarchyFromParoisse(fidele.paroisse_id)
  ...
  async function handleImageUpload(file: File) {
    ...
    try {
      const result = await uploadFideleImage(formData)
  ...
  return (
    <>
      {/* Input file caché pour l'upload d'image */}
      <input
        ref={fileInputRef}
        type="file"
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
         <ExportCarteFideleButton 
  fidele={fidele}
  structureInfo={{
    region: structureInfo.region || 'Non définie',
    conference: structureInfo.conference || 'Non définie',
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mb-4 relative group">
                  ...
                  >
                    ...
                    {/* Overlay au hover */}
                    <div className="absolute w-24 h-24  mx-auto inset-0 rounded-full bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-200 flex items-center justify-center opacity-0 group-hover:opacity-100">
                      {isUploading ? (
